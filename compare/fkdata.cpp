...
// 设置区
namespace Settings {
const int MAX_LEN = 20;  // 发现错误时,显示错误行数据的最大长度
const int CASE_CNT = 1000;                 // 对拍测试次数
const int BUFFER_SIZE = 1 << 10;          // 每行的缓冲区大小
const char *const dataFile = "makedata.cpp";  // 随机生成数据的源代码文件名
